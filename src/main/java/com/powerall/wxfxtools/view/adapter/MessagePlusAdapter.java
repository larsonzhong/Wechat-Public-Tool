 ...
 public class MessagePlusAdapter extends BaseAdapter {
     ...
     Context mContext;
     List<MessagePlusEntity> mData = new ArrayList<MessagePlusEntity>();
     ...
     // 添加数据
     public void addItem(MessagePlusEntity item) {
         mData.add(item);
     }
     ...
     public View getView(int position, View convertView, ViewGroup parent) {
         ...
         MessagePlusEntity item = mData.get(position);
         if (convertView == null) {
